...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CredentialRotation)(nil), (*azure.CredentialRotation)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CredentialRotation_To_azure_CredentialRotation(a.(*CredentialRotation), b.(*azure.CredentialRotation), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*azure.CredentialRotation)(nil), (*CredentialRotation)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_azure_CredentialRotation_To_v1alpha1_CredentialRotation(a.(*azure.CredentialRotation), b.(*CredentialRotation), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_BackupBucketConfig_To_azure_BackupBucketConfig(in *BackupBucketConfig, out *azure.BackupBucketConfig, s conversion.Scope) error {
	...
	out.CredentialRotation = (*azure.CredentialRotation)(unsafe.Pointer(in.CredentialRotation))
	return nil
}
...
func autoConvert_azure_BackupBucketConfig_To_v1alpha1_BackupBucketConfig(in *azure.BackupBucketConfig, out *BackupBucketConfig, s conversion.Scope) error {
	...
	out.CredentialRotation = (*CredentialRotation)(unsafe.Pointer(in.CredentialRotation))
	return nil
}
...
func autoConvert_v1alpha1_CredentialRotation_To_azure_CredentialRotation(in *CredentialRotation, out *azure.CredentialRotation, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_v1alpha1_CredentialRotation_To_azure_CredentialRotation is an autogenerated conversion function.
func Convert_v1alpha1_CredentialRotation_To_azure_CredentialRotation(in *CredentialRotation, out *azure.CredentialRotation, s conversion.Scope) error {
	return autoConvert_v1alpha1_CredentialRotation_To_azure_CredentialRotation(in, out, s)
}

func autoConvert_azure_CredentialRotation_To_v1alpha1_CredentialRotation(in *azure.CredentialRotation, out *CredentialRotation, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_azure_CredentialRotation_To_v1alpha1_CredentialRotation is an autogenerated conversion function.
func Convert_azure_CredentialRotation_To_v1alpha1_CredentialRotation(in *azure.CredentialRotation, out *CredentialRotation, s conversion.Scope) error {
	return autoConvert_azure_CredentialRotation_To_v1alpha1_CredentialRotation(in, out, s)
}
