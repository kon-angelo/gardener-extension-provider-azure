...
func autoConvert_v1alpha1_NetworkConfig_To_azure_NetworkConfig(in *NetworkConfig, out *azure.NetworkConfig, s conversion.Scope) error {
	...
	out.SubnetConfig = (*azure.SubnetConfig)(unsafe.Pointer(in.SubnetConfig))
...
func autoConvert_azure_NetworkConfig_To_v1alpha1_NetworkConfig(in *azure.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	...
	out.SubnetConfig = (*SubnetConfig)(unsafe.Pointer(in.SubnetConfig))
	out.Workers = (*string)(unsafe.Pointer(in.Workers))
...
func autoConvert_v1alpha1_SubnetConfig_To_azure_SubnetConfig(in *SubnetConfig, out *azure.SubnetConfig, s conversion.Scope) error {
	out.EnablePrivateLinkServiceNetworkPolicies = (*bool)(unsafe.Pointer(in.EnablePrivateLinkServiceNetworkPolicies))
	out.EnablePrivateEndpointNetworkPolicies = (*bool)(unsafe.Pointer(in.EnablePrivateEndpointNetworkPolicies))
	return nil
}
