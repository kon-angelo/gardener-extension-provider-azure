...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Identifier)(nil), (*azure.Identifier)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Identifier_To_azure_Identifier(a.(*Identifier), b.(*azure.Identifier), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*azure.Identifier)(nil), (*Identifier)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_azure_Identifier_To_v1alpha1_Identifier(a.(*azure.Identifier), b.(*Identifier), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Identifier_To_azure_Identifier(in *Identifier, out *azure.Identifier, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Id = in.Id
	out.Owner = in.Owner
	return nil
...
// Convert_v1alpha1_Identifier_To_azure_Identifier is an autogenerated conversion function.
func Convert_v1alpha1_Identifier_To_azure_Identifier(in *Identifier, out *azure.Identifier, s conversion.Scope) error {
	return autoConvert_v1alpha1_Identifier_To_azure_Identifier(in, out, s)
}

func autoConvert_azure_Identifier_To_v1alpha1_Identifier(in *azure.Identifier, out *Identifier, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Id = in.Id
	out.Owner = in.Owner
	return nil
...
// Convert_azure_Identifier_To_v1alpha1_Identifier is an autogenerated conversion function.
func Convert_azure_Identifier_To_v1alpha1_Identifier(in *azure.Identifier, out *Identifier, s conversion.Scope) error {
	return autoConvert_azure_Identifier_To_v1alpha1_Identifier(in, out, s)
}
...
func autoConvert_v1alpha1_InfrastructureState_To_azure_InfrastructureState(in *InfrastructureState, out *azure.InfrastructureState, s conversion.Scope) error {
	...
	out.Inventory = *(*[]azure.Identifier)(unsafe.Pointer(&in.Inventory))
	return nil
}
...
func autoConvert_azure_InfrastructureState_To_v1alpha1_InfrastructureState(in *azure.InfrastructureState, out *InfrastructureState, s conversion.Scope) error {
	out.Data = *(*map[string]string)(unsafe.Pointer(&in.Data))
	out.Inventory = *(*[]Identifier)(unsafe.Pointer(&in.Inventory))
	return nil
}
