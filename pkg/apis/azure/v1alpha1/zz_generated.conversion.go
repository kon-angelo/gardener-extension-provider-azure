...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Identifier)(nil), (*azure.Identifier)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AzureResource_To_azure_AzureResource(a.(*Identifier), b.(*azure.Identifier), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*azure.Identifier)(nil), (*Identifier)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_azure_AzureResource_To_v1alpha1_AzureResource(a.(*azure.Identifier), b.(*Identifier), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AzureResource_To_azure_AzureResource(in *Identifier, out *azure.Identifier, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Id = in.Id
	return nil
}
...
func Convert_v1alpha1_AzureResource_To_azure_AzureResource(in *Identifier, out *azure.Identifier, s conversion.Scope) error {
	return autoConvert_v1alpha1_AzureResource_To_azure_AzureResource(in, out, s)
}

func autoConvert_azure_AzureResource_To_v1alpha1_AzureResource(in *azure.Identifier, out *Identifier, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Id = in.Id
	return nil
}
...
func Convert_azure_AzureResource_To_v1alpha1_AzureResource(in *azure.Identifier, out *Identifier, s conversion.Scope) error {
