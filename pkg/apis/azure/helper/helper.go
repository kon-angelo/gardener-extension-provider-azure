...
// whose purpose matches with the given purpose and zone. If no such entry is found then an error will be
// returned.
func FindSubnetByPurposeAndZone(subnets []api.Subnet, purpose api.Purpose, zone int32) (int, *api.Subnet, error) {
