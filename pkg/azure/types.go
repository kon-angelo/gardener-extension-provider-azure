...
const (
	...
	// GlobalAnnotationKeyUseTF is the annotation key used to enable reconciliation terraformer.
	GlobalAnnotationKeyUseTF = "provider.extensions.gardener.cloud/use-tf"
	...
	AnnotationKeyUseFlow = "azure." + GlobalAnnotationKeyUseFlow
	// AnnotationKeyUseTF is the annotation key used to enable reconciliation terraformer.
	AnnotationKeyUseTF = "azure." + GlobalAnnotationKeyUseTF
